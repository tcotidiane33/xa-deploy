...
@section('content')
    <div class="container mx-auto w-full">
        ...
        @php
            $currentPeriode = $currentPeriode ?? null;
        @endphp

        @if ($currentPeriode)
            <h1 class="text-2xl font-bold text-blue-600 mb-4">Période de Paie en cours : {{ $currentPeriode->reference }}
            </h1>
        @else
        ...
        @if (Auth::user()->hasRole(['Admin', 'Responsable', 'Gestionnaire']))
            <div class="mb-4">
                ...
                <span class="p-1"></span>
                <form action="{{ route('periodes-paie.migrate') }}" method="POST" class="inline">
                    @csrf
                    @method('PATCH')
        ...
        <!-- Rappel sur les sauvegardes -->
        <div class="bg-blue-100 p-4 rounded mb-4 mt-2">
            <h2 class="text-xl font-bold text-indigo-800 mb-2">Rappel sur les Sauvegardes</h2>
            <p class="text-indigo-700 mb-2">
                Les données de période de paie et de traitement de paie sont sans cesse renouvelées. Après une migration ou une période de paie expirée ou clôturée, ces informations sont à retrouver dans les backups (Laravel Backup).
            </p>
        </div>
        <hr>
         ...
         <div class="bg-blue-100 p-4 rounded mb-4 mt-3">
            <h2 class="text-xl font-bold text-indigo-800 mb-2">Description de la Migration</h2>
            <p class="text-indigo-700 mb-2">
                La migration complète permet de transférer tous les clients vers une nouvelle période de paie. Les données suivantes sont conservées :
            </p>
            <ul class="list-disc list-inside text-indigo-700 mb-2">
                <li>Gestionnaire</li>
                <li>NB Bulletins</li>
                <li>Client</li>
                <li>Maj fiche para</li>
                <li>Notes</li>
            </ul>
            <p class="text-blue-700 mb-2">
                Les données suivantes doivent être saisies de nouveau à chaque migration :
            </p>
            <ul class="list-disc list-inside text-indigo-700 mb-2">
                <li>Réception variables</li>
                <li>Préparation BP</li>
                <li>Validation BP client</li>
                <li>Préparation et envoie DSN</li>
                <li>Accusés DSN</li>
            </ul>
            <p class="text-blue-700">
                La migration ne peut être effectuée que si toutes les fiches clients de la période actuelle sont complètes.
            </p>
        </div>
