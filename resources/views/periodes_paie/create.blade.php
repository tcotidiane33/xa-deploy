            ...
            <form action="{{ route('periodes-paie.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="reference" id="reference"
                            ...
                            value="{{ old('reference') }}" placeholder="ex: Paie Janvier 2024" required>
                        @error('reference')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="debut" id="debut" title="Format: YYYY-MM-DD"
                            class="date form-input w-sm rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('debut') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input datepicker datepicker-format="yyyy-mm-dd"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-sm pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:ring-opacity-50 @error('fin') border-red-500 @enderror"
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="delais[reception_variables]" class="form-input w-full rounded-md"
                                value="{{ old('delais.reception_variables', -3) }}" placeholder="Jours avant la fin">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Préparation BP
                            </label>
                            <input type="number" name="delais[preparation_bp]" class="form-input w-full rounded-md"
                                value="{{ old('delais.preparation_bp', -2) }}" placeholder="Jours avant la fin">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Validation BP
                            </label>
                            <input type="number" name="delais[validation_bp]" class="form-input w-full rounded-md"
                                value="{{ old('delais.validation_bp', -1) }}" placeholder="Jours avant la fin">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Envoi DSN
                            </label>
                            <input type="number" name="delais[preparation_dsn]" class="form-input w-full rounded-md"
                                value="{{ old('delais.preparation_dsn', 3) }}" placeholder="Jours après la fin">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Accusés DSN
                            </label>
                            <input type="number" name="delais[accuses_dsn]" class="form-input w-full rounded-md"
                                value="{{ old('delais.accuses_dsn', 5) }}" placeholder="Jours après la fin">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <button type="button" onclick="window.location='{{ route('periodes-paie.index') }}'"
...
@push('scripts')
    ...
    <script>
        ...
        flatpickr(".datepicker", {
            ...
            dateFormat: "Y-m-d", // Format de date : YYYY-MM-DD
