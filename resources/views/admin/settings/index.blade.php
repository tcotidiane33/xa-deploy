    ...
    <div class="container mx-auto p-4">
        ...
        <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="site_name" id="site_name" value="{{ $settings['site_name'] ?? '' }}" required class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>

            <div class="mb-4">
                <label for="site_description" class="block text-sm font-medium text-gray-700">Description du site</label>
                <textarea name="site_description" id="site_description" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ $settings['site_description'] ?? '' }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="default_user_role" id="default_user_role" required class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="items_per_page" id="items_per_page" value="{{ $settings['items_per_page'] ?? 10 }}" required min="5" max="100" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
